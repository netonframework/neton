...
class StreamTextRequestBuilder {
    ...
    internal fun build(): StreamTextRequest = StreamTextRequest(
...
@PublishedApi
internal fun StreamTextRequestBuilder.toRequest(): StreamTextRequest = build()
