...
class SecurityController {
    ...
    /**
     * 获取当前用户信息 - @CurrentUser
     * 注入当前认证的用户身份
     */
    @Get("/profile")
    @RequireAuth
    fun getCurrentUser(@CurrentUser principal: Identity): String {
    ...
    @Get("/visitor")
    @AllowAnonymous
    fun visitorInfo(@CurrentUser principal: Identity?): String {
    ...
    @Get("/dashboard")
    @RequireAuth
    fun dashboard(@CurrentUser principal: Identity): String {
        val content = when {
